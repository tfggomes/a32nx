...
/* eslint-disable camelcase,no-redeclare */
...
const WeatherWidget = (props: WeatherWidgetProps) => {
    ...
    function getMetar(icao: any, metarSource: any) {
        if (icao.length !== 4) {
            return new Promise(() => {
                setMetar(MetarParserTypeProp);
            });
        }
        return Metar.get(icao, metarSource)
            .then((result) => {
                        ...
                        <div className="mb-6">
                            <div className="grid grid-cols-2">
                                ...
                                <div className="text-center text-lg">
                                    ...
                                    {' '}
                                    <IconPoint className="inline-block -mx-1 -mt-3" size={20} stroke={2} strokeLinejoin="miter" />
                                    {' '}
                                    /
                                    {' '}
