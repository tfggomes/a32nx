...
void FlightDataRecorderConverter::writeHeader(ofstream& out, const string& delimiter) {
  ...
  out << "ap_sm.data.ap_fd_active" << delimiter;
  out << "ap_sm.data.ap_V_c_kn" << delimiter;
  out << "ap_sm.data.ap_H_c_ft" << delimiter;
  out << "ap_sm.data.ap_Psi_c_deg" << delimiter;
  out << "ap_sm.data.ap_H_dot_c_ft_min" << delimiter;
  out << "ap_sm.data.ap_FPA_c_deg" << delimiter;
  out << "ap_sm.data.nav_valid" << delimiter;
  out << "ap_sm.data.nav_loc_deg" << delimiter;
  out << "ap_sm.data.nav_radial_error_deg" << delimiter;
  ...
  out << "ap_sm.vertical.output.V_SRS_c_kn" << delimiter;
  ...
  out << "ap_sm.vertical_previous.output.V_SRS_c_kn" << delimiter;
  ...
  out << "ap_sm.output.V_SRS_c_kn" << delimiter;
