...
const uint8_T AutopilotLaws_IN_any_c = 1U;
...
void AutopilotLawsModelClass::AutopilotLaws_Chart_e_Init(rtDW_Chart_AutopilotLaws_g_T *localDW)
{
...
void AutopilotLawsModelClass::AutopilotLaws_Chart_e(real_T rtu_right, real_T rtu_left, boolean_T rtu_use_short_path,
  real_T *rty_out, rtDW_Chart_AutopilotLaws_g_T *localDW)
{
  real_T tmp;
  real_T tmp_0;
  boolean_T tmp_1;
  if (localDW->is_active_c1_AutopilotLaws == 0U) {
    ...
    localDW->is_c1_AutopilotLaws = AutopilotLaws_IN_any_c;
    if (std::abs(rtu_left) < std::abs(rtu_right)) {
      *rty_out = rtu_left;
    } else {
      *rty_out = rtu_right;
...
void AutopilotLawsModelClass::step()
{
  ...
  rtb_Mod1_n = 0.017453292519943295 * rtb_GainTheta1;
  rtb_out_c = std::tan(rtb_Saturation1);
  rtb_Saturation = std::sin(rtb_Mod1_n);
  rtb_Mod1_n = std::cos(rtb_Mod1_n);
  tmp[0] = 1.0;
  tmp[3] = rtb_Saturation * rtb_out_c;
  tmp[6] = rtb_Mod1_n * rtb_out_c;
  tmp[1] = 0.0;
  tmp[4] = rtb_Mod1_n;
  tmp[7] = -rtb_Saturation;
  tmp[2] = 0.0;
  rtb_Mod1_i = 1.0 / std::cos(rtb_Saturation1);
  tmp[5] = rtb_Mod1_i * rtb_Saturation;
  tmp[8] = rtb_Mod1_i * rtb_Mod1_n;
  ...
  AutopilotLaws_Chart(rtb_Saturation1, AutopilotLaws_P.Gain_Gain_h * rt_modd(AutopilotLaws_P.Constant3_Value_o -
    rtb_Saturation1, AutopilotLaws_P.Constant3_Value_o), AutopilotLaws_P.Constant2_Value_l, &rtb_out_c,
                      &AutopilotLaws_DWork.sf_Chart_df);
  ...
  rtb_Minup = rtb_out_c + AutopilotLaws_P.Constant_Value_a;
  AutopilotLaws_DWork.Delay1_DSTATE = 1.0 / rtb_Minup * (AutopilotLaws_P.Constant_Value_a - rtb_out_c) *
  ...
  if (AutopilotLaws_U.in.data.nav_dme_nmi > AutopilotLaws_P.Saturation_UpperSat_o) {
    rtb_Mod1_i = AutopilotLaws_P.Saturation_UpperSat_o;
  } else if (AutopilotLaws_U.in.data.nav_dme_nmi < AutopilotLaws_P.Saturation_LowerSat_o) {
    rtb_Mod1_i = AutopilotLaws_P.Saturation_LowerSat_o;
  } else {
    rtb_Mod1_i = AutopilotLaws_U.in.data.nav_dme_nmi;
  }

  rtb_out_c = std::sin(AutopilotLaws_P.Gain1_Gain_g * AutopilotLaws_U.in.data.nav_loc_error_deg) * rtb_Mod1_i *
  ...
  rtb_Mod1_n = AutopilotLaws_U.in.data.nav_loc_error_deg + AutopilotLaws_U.in.data.nav_loc_deg;
  rtb_Mod1_i = rt_modd((AutopilotLaws_U.in.data.Psi_magnetic_deg - (rt_modd(rt_modd(rtb_Mod1_n,
    AutopilotLaws_P.Constant3_Value_oz) + AutopilotLaws_P.Constant3_Value_oz, AutopilotLaws_P.Constant3_Value_oz) +
    AutopilotLaws_P.Constant3_Value_k)) + AutopilotLaws_P.Constant3_Value_k, AutopilotLaws_P.Constant3_Value_k);
  rtb_Mod2 = rt_modd(AutopilotLaws_P.Constant3_Value_k - rtb_Mod1_i, AutopilotLaws_P.Constant3_Value_k);
  if (rtb_Mod1_i < rtb_Mod2) {
    rtb_Mod1_i *= AutopilotLaws_P.Gain1_Gain_d;
  } else {
    rtb_Mod1_i = AutopilotLaws_P.Gain_Gain_i * rtb_Mod2;
  }
  ...
  rtb_out_c = rt_modd((rt_modd(rt_modd(((rtb_out_c * look1_binlxpw(AutopilotLaws_U.in.data.V_gnd_kn,
    ...
    AutopilotLaws_DWork.Delay_DSTATE_h) + AutopilotLaws_P.Gain1_Gain_f * rtb_Mod1_i) +
    AutopilotLaws_U.in.data.Psi_magnetic_deg, AutopilotLaws_P.Constant3_Value_m) + AutopilotLaws_P.Constant3_Value_m,
    AutopilotLaws_P.Constant3_Value_m) - (AutopilotLaws_U.in.data.Psi_magnetic_deg + AutopilotLaws_P.Constant3_Value_o4))
                      + AutopilotLaws_P.Constant3_Value_o4, AutopilotLaws_P.Constant3_Value_o4);
  AutopilotLaws_Chart(rtb_out_c, AutopilotLaws_P.Gain_Gain_nu * rt_modd(AutopilotLaws_P.Constant3_Value_o4 - rtb_out_c,
    AutopilotLaws_P.Constant3_Value_o4), AutopilotLaws_P.Constant1_Value_e, &rtb_Mod1_i, &AutopilotLaws_DWork.sf_Chart_k);
  switch (static_cast<int32_T>(rtb_ManualSwitch)) {
   ...
   default:
    rtb_out_c = (AutopilotLaws_P.Gain5_Gain * rtb_Mod1_i + AutopilotLaws_P.Gain_Gain_b * result[2]) + rtb_Saturation;
    break;
  }
  ...
  if (rtb_Divide_e > 100.0) {
    ...
    if (rtb_Divide_e < 0.0) {
      rtb_Mod1_i = std::ceil(rtb_Divide_e);
    } else {
      rtb_Mod1_i = std::floor(rtb_Divide_e);
    }

    rtb_Mod1_i = std::fmod(rtb_Mod1_i, 4.294967296E+9);
    rtb_Divide_o = rtb_Mod1_i < 0.0 ? static_cast<uint32_T>(-static_cast<int32_T>(static_cast<uint32_T>(-rtb_Mod1_i))) :
      static_cast<uint32_T>(rtb_Mod1_i);
  }
  ...
  AutopilotLaws_Chart_e(rtb_Mod2, AutopilotLaws_P.Gain_Gain_dd * rt_modd(AutopilotLaws_P.Constant3_Value_h - rtb_Mod2,
    AutopilotLaws_P.Constant3_Value_h), rtb_Compare_c != rtb_Compare_k0, &rtb_out_l, &AutopilotLaws_DWork.sf_Chart_e);
  ...
  rtb_Divide_e = AutopilotLaws_P.Subsystem_Value_n / AutopilotLaws_U.in.time.dt;
  if (!rtb_Compare_k0) {
    for (i = 0; i < 100; i++) {
  ...
  if (rtb_Divide_e < 1.0) {
    ...
    rtb_Divide_g_0 = AutopilotLaws_DWork.Delay_DSTATE_h5[100U - rtb_Divide_o];
  }

  AutopilotLaws_Chart_e(rtb_Mod2, AutopilotLaws_P.Gain_Gain_br * rt_modd(AutopilotLaws_P.Constant3_Value_mj - rtb_Mod2,
    AutopilotLaws_P.Constant3_Value_mj), rtb_Compare_k0 != rtb_Divide_g_0, &rtb_out, &AutopilotLaws_DWork.sf_Chart_b);
  rtb_Divide_e = AutopilotLaws_P.Gain_Gain_nu3 * AutopilotLaws_U.in.data.flight_guidance_xtk_nmi;
  if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_k) {
    rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_k;
  } else {
    if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_p) {
      rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_p;
    }
  }

  rtb_Mod1_i = rt_modd((rt_modd(rt_modd((AutopilotLaws_P.Gain2_Gain_f * AutopilotLaws_U.in.data.flight_guidance_tae_deg
    + rtb_Divide_e) * AutopilotLaws_P.Gain1_Gain_n + AutopilotLaws_U.in.data.Psi_magnetic_track_deg,
  ...
  AutopilotLaws_Chart(rtb_Mod1_i, AutopilotLaws_P.Gain_Gain_g * rt_modd(AutopilotLaws_P.Constant3_Value_l - rtb_Mod1_i,
    AutopilotLaws_P.Constant3_Value_l), AutopilotLaws_P.Constant_Value_c, &rtb_out_cj, &AutopilotLaws_DWork.sf_Chart);
  rtb_Mod1_n = rt_modd((AutopilotLaws_U.in.data.Psi_magnetic_track_deg - (rt_modd(rt_modd(rtb_Mod1_n,
  ...
  rtb_Mod2 = rt_modd(AutopilotLaws_P.Constant3_Value_fb - rtb_Mod1_n, AutopilotLaws_P.Constant3_Value_fb);
  if (AutopilotLaws_U.in.data.nav_dme_nmi > AutopilotLaws_P.Saturation_UpperSat_m) {
    rtb_Mod1_i = AutopilotLaws_P.Saturation_UpperSat_m;
  } else if (AutopilotLaws_U.in.data.nav_dme_nmi < AutopilotLaws_P.Saturation_LowerSat_k) {
    rtb_Mod1_i = AutopilotLaws_P.Saturation_LowerSat_k;
  } else {
    rtb_Mod1_i = AutopilotLaws_U.in.data.nav_dme_nmi;
  }

  rtb_Divide_e = std::sin(AutopilotLaws_P.Gain1_Gain_fj * AutopilotLaws_U.in.data.nav_loc_error_deg) * rtb_Mod1_i *
  ...
  if (rtb_Divide_e > AutopilotLaws_P.Saturation1_UpperSat_i) {
    rtb_Divide_e = AutopilotLaws_P.Saturation1_UpperSat_i;
  } else {
    if (rtb_Divide_e < AutopilotLaws_P.Saturation1_LowerSat_g) {
      rtb_Divide_e = AutopilotLaws_P.Saturation1_LowerSat_g;
    }
  }

  if (rtb_Mod1_n < rtb_Mod2) {
    rtb_Mod1_n *= AutopilotLaws_P.Gain1_Gain;
  } else {
    rtb_Mod1_n = AutopilotLaws_P.Gain_Gain * rtb_Mod2;
  }

  rtb_Mod1_n = rt_modd((rt_modd(rt_modd((rtb_Divide_e + rtb_Mod1_n) * AutopilotLaws_P.Gain3_Gain +
    ...
    AutopilotLaws_P.Constant3_Value_p, AutopilotLaws_P.Constant3_Value_p) -
                        (AutopilotLaws_U.in.data.Psi_magnetic_track_deg + AutopilotLaws_P.Constant3_Value_ht)) +
                       AutopilotLaws_P.Constant3_Value_ht, AutopilotLaws_P.Constant3_Value_ht);
  AutopilotLaws_Chart(rtb_Mod1_n, AutopilotLaws_P.Gain_Gain_my * rt_modd(AutopilotLaws_P.Constant3_Value_ht - rtb_Mod1_n,
    AutopilotLaws_P.Constant3_Value_ht), AutopilotLaws_P.Constant_Value_e, &rtb_Divide_e,
                      &AutopilotLaws_DWork.sf_Chart_a);
  rtb_Mod1_n = AutopilotLaws_P.DiscreteDerivativeVariableTs_Gain * AutopilotLaws_U.in.data.nav_loc_error_deg;
  rtb_Mod1_i = (rtb_Mod1_n - AutopilotLaws_DWork.Delay_DSTATE_p) / AutopilotLaws_U.in.time.dt *
  ...
  rtb_Minup = rtb_Mod2 + AutopilotLaws_P.Constant_Value_o;
  AutopilotLaws_DWork.Delay1_DSTATE_c = 1.0 / rtb_Minup * (AutopilotLaws_P.Constant_Value_o - rtb_Mod2) *
    AutopilotLaws_DWork.Delay1_DSTATE_c + (rtb_Mod1_i + AutopilotLaws_DWork.Delay_DSTATE_g) * (rtb_Mod2 / rtb_Minup);
  rtb_Mod2 = rt_modd((rt_modd(rt_modd(AutopilotLaws_DWork.Delay1_DSTATE_c * look1_binlxpw
    ...
    AutopilotLaws_P.Constant3_Value_ld) + AutopilotLaws_P.Constant3_Value_ld, AutopilotLaws_P.Constant3_Value_ld) -
  ...
  AutopilotLaws_Chart(rtb_Mod2, AutopilotLaws_P.Gain_Gain_il * rt_modd(AutopilotLaws_P.Constant3_Value_fa - rtb_Mod2,
    AutopilotLaws_P.Constant3_Value_fa), AutopilotLaws_P.Constant_Value_p, &rtb_Minup, &AutopilotLaws_DWork.sf_Chart_d);
  switch (static_cast<int32_T>(rtb_ManualSwitch)) {
   case 0:
  ...
  rtb_Divide_e = rtb_Mod2 - AutopilotLaws_DWork.Delay_DSTATE_hc;
  rtb_ManualSwitch_i = AutopilotLaws_P.Constant2_Value_h * AutopilotLaws_U.in.time.dt;
  if (rtb_Divide_e < rtb_ManualSwitch_i) {
    rtb_ManualSwitch_i = rtb_Divide_e;
  }

  rtb_Divide_e = AutopilotLaws_P.Gain1_Gain_k * AutopilotLaws_P.Constant2_Value_h * AutopilotLaws_U.in.time.dt;
  if (rtb_ManualSwitch_i > rtb_Divide_e) {
    rtb_Divide_e = rtb_ManualSwitch_i;
  }

  AutopilotLaws_DWork.Delay_DSTATE_hc += rtb_Divide_e;
  rtb_Divide_e = AutopilotLaws_U.in.time.dt * AutopilotLaws_P.LagFilter_C1_l;
  rtb_Minup = rtb_Divide_e + AutopilotLaws_P.Constant_Value_pz;
  AutopilotLaws_DWork.Delay1_DSTATE_l = 1.0 / rtb_Minup * (AutopilotLaws_P.Constant_Value_pz - rtb_Divide_e) *
    AutopilotLaws_DWork.Delay1_DSTATE_l + (AutopilotLaws_DWork.Delay_DSTATE_hc + AutopilotLaws_DWork.Delay_DSTATE_m) *
    (rtb_Divide_e / rtb_Minup);
  rtb_Divide_e = static_cast<real_T>(rtb_BusAssignment_output_ap_on) - AutopilotLaws_DWork.Delay_DSTATE_my;
  rtb_ManualSwitch_i = AutopilotLaws_P.RateLimiterVariableTs_up * AutopilotLaws_U.in.time.dt;
  if (rtb_Divide_e < rtb_ManualSwitch_i) {
    rtb_ManualSwitch_i = rtb_Divide_e;
  }

  rtb_Divide_e = AutopilotLaws_U.in.time.dt * AutopilotLaws_P.RateLimiterVariableTs_lo;
  if (rtb_ManualSwitch_i > rtb_Divide_e) {
    rtb_Divide_e = rtb_ManualSwitch_i;
  }

  AutopilotLaws_DWork.Delay_DSTATE_my += rtb_Divide_e;
  if (AutopilotLaws_DWork.Delay_DSTATE_my > AutopilotLaws_P.Saturation_UpperSat_d) {
    rtb_Sum_ox = AutopilotLaws_P.Saturation_UpperSat_d;
  } else if (AutopilotLaws_DWork.Delay_DSTATE_my < AutopilotLaws_P.Saturation_LowerSat_d) {
    rtb_Sum_ox = AutopilotLaws_P.Saturation_LowerSat_d;
  } else {
    rtb_Sum_ox = AutopilotLaws_DWork.Delay_DSTATE_my;
  }

  rtb_ManualSwitch = AutopilotLaws_DWork.Delay1_DSTATE_l * rtb_Sum_ox;
  rtb_Sum_ox = AutopilotLaws_P.Constant_Value_co - rtb_Sum_ox;
  ...
  rtb_ROLLLIM1 = (rtb_ManualSwitch - AutopilotLaws_DWork.Delay_DSTATE_a) / AutopilotLaws_U.in.time.dt *
  ...
  rtb_Divide_e = rtb_Sum_ox + AutopilotLaws_P.Constant_Value_cb;
  AutopilotLaws_DWork.Delay1_DSTATE_j = 1.0 / rtb_Divide_e * (AutopilotLaws_P.Constant_Value_cb - rtb_Sum_ox) *
    AutopilotLaws_DWork.Delay1_DSTATE_j + (rtb_ROLLLIM1 + AutopilotLaws_DWork.Delay_DSTATE_b) * (rtb_Sum_ox /
    rtb_Divide_e);
  rtb_Divide_e = AutopilotLaws_DWork.Delay1_DSTATE_j - AutopilotLaws_U.in.input.V_c_kn;
  if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_h) {
    rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_h;
  } else {
    if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_c) {
      rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_c;
    }
  }

  rtb_Sum_ox = AutopilotLaws_P.Gain1_Gain_b * rtb_Divide_e;
  rtb_Mod2 = AutopilotLaws_P.Gain1_Gain_p * AutopilotLaws_U.in.data.alpha_deg;
  rtb_out_c = AutopilotLaws_U.in.data.bz_m_s2 * std::sin(rtb_Mod2);
  rtb_Mod2 = std::cos(rtb_Mod2);
  rtb_Mod2 *= AutopilotLaws_U.in.data.bx_m_s2;
  rtb_Mod2 = (rtb_out_c + rtb_Mod2) * AutopilotLaws_P.Gain_Gain_c3 * AutopilotLaws_P.Gain_Gain_p;
  rtb_Divide_e = AutopilotLaws_P.Gain1_Gain_k0 * std::abs(AutopilotLaws_P.Constant_Value_em) + std::abs(rtb_Mod2);
  if (rtb_Divide_e <= AutopilotLaws_P.Constant1_Value_ef) {
    rtb_Divide_e = AutopilotLaws_P.Constant1_Value_ef;
  }

  rtb_out_c = std::abs(rtb_Sum_ox);
  if (rtb_out_c < rtb_Divide_e) {
    rtb_Divide_e = rtb_out_c;
  }
  ...
  rtb_Sum1_g = rtb_Sum_ox - rtb_Divide_e * rtb_Mod2 * AutopilotLaws_P.Gain_Gain_h4;
  rtb_out_l = AutopilotLaws_P.DiscreteDerivativeVariableTs_Gain_l * AutopilotLaws_U.in.data.nav_gs_error_deg;
  rtb_out = (rtb_out_l - AutopilotLaws_DWork.Delay_DSTATE_l) / AutopilotLaws_U.in.time.dt * AutopilotLaws_P.Gain3_Gain_o
  ...
  rtb_Divide_e = rtb_Sum_ox + AutopilotLaws_P.Constant_Value_g;
  AutopilotLaws_DWork.Delay1_DSTATE_b = 1.0 / rtb_Divide_e * (AutopilotLaws_P.Constant_Value_g - rtb_Sum_ox) *
    AutopilotLaws_DWork.Delay1_DSTATE_b + (rtb_out + AutopilotLaws_DWork.Delay_DSTATE_by) * (rtb_Sum_ox / rtb_Divide_e);
  ...
  rtb_out_cj = AutopilotLaws_P.DiscreteDerivativeVariableTs_Gain_lf * AutopilotLaws_U.in.data.V_ias_kn;
  rtb_Minup = (rtb_out_cj - AutopilotLaws_DWork.Delay_DSTATE_j) / AutopilotLaws_U.in.time.dt *
  ...
  rtb_Divide_e = rtb_Sum_ox + AutopilotLaws_P.Constant_Value_eg;
  AutopilotLaws_DWork.Delay1_DSTATE_cx = 1.0 / rtb_Divide_e * (AutopilotLaws_P.Constant_Value_eg - rtb_Sum_ox) *
    AutopilotLaws_DWork.Delay1_DSTATE_cx + (rtb_Minup + AutopilotLaws_DWork.Delay_DSTATE_e) * (rtb_Sum_ox / rtb_Divide_e);
  rtb_Divide_e = AutopilotLaws_DWork.Delay1_DSTATE_cx - AutopilotLaws_U.in.input.V_c_kn;
  if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_nk) {
    rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_nk;
  } else {
    if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_h) {
      rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_h;
    }
  }

  rtb_Sum_ox = AutopilotLaws_P.Gain1_Gain_pc * rtb_Divide_e;
  rtb_Mod2 = AutopilotLaws_P.Gain1_Gain_g4 * AutopilotLaws_U.in.data.alpha_deg;
  rtb_out_c = AutopilotLaws_U.in.data.bz_m_s2 * std::sin(rtb_Mod2);
  rtb_Mod2 = std::cos(rtb_Mod2);
  rtb_Mod2 *= AutopilotLaws_U.in.data.bx_m_s2;
  rtb_Mod2 = (rtb_out_c + rtb_Mod2) * AutopilotLaws_P.Gain_Gain_bd * AutopilotLaws_P.Gain_Gain_o;
  rtb_Divide_e = std::abs(rtb_Sum_ox);
  rtb_out_c = AutopilotLaws_P.Gain1_Gain_k4 * std::abs(AutopilotLaws_P.Constant_Value_j) + std::abs(rtb_Mod2);
  if (rtb_out_c <= AutopilotLaws_P.Constant1_Value_l) {
    rtb_out_c = AutopilotLaws_P.Constant1_Value_l;
  }

  u0 = AutopilotLaws_P.kntoms_Gain_f * AutopilotLaws_U.in.data.V_tas_kn;
  if (u0 > AutopilotLaws_P.Saturation_UpperSat_nn) {
    u0 = AutopilotLaws_P.Saturation_UpperSat_nn;
  } else {
    if (u0 < AutopilotLaws_P.Saturation_LowerSat_l) {
      u0 = AutopilotLaws_P.Saturation_LowerSat_l;
    }
  }

  u0 = (AutopilotLaws_P.Constant_Value_i - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain_j / u0;
  x[0] = AutopilotLaws_P.Constant1_Value_d - rtb_GainTheta;
  if (rtb_Divide_e < rtb_out_c) {
    rtb_out_c = rtb_Divide_e;
  }
  ...
  x[1] = rtb_Sum_ox - rtb_out_c * rtb_Mod2 * AutopilotLaws_P.Gain_Gain_hk;
  if (u0 > 1.0) {
    u0 = 1.0;
  } else {
    if (u0 < -1.0) {
  ...
  x[2] = AutopilotLaws_P.Gain_Gain_l * std::asin(u0) * AutopilotLaws_P.VS_Gain_c;
  switch (static_cast<int32_T>(rtb_ManualSwitch_i)) {
   ...
   case 1:
    rtb_Divide_e = (AutopilotLaws_B.u_n - AutopilotLaws_U.in.data.H_ft) * AutopilotLaws_P.Gain_Gain_f;
    rtb_out_c = AutopilotLaws_P.kntoms_Gain * AutopilotLaws_U.in.data.V_tas_kn;
    if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_n) {
      rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_n;
    } else {
      if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_d4) {
        rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_d4;
      }
    }

    if (rtb_out_c > AutopilotLaws_P.Saturation_UpperSat_l) {
      rtb_out_c = AutopilotLaws_P.Saturation_UpperSat_l;
    } else {
      if (rtb_out_c < AutopilotLaws_P.Saturation_LowerSat_m) {
        rtb_out_c = AutopilotLaws_P.Saturation_LowerSat_m;
      }
    }

    rtb_Divide_e = (rtb_Divide_e - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain / rtb_out_c;
    if (rtb_Divide_e > 1.0) {
      rtb_Divide_e = 1.0;
    } else {
      if (rtb_Divide_e < -1.0) {
    ...
    rtb_Sum_ox = AutopilotLaws_P.Gain_Gain_bs * std::asin(rtb_Divide_e) * AutopilotLaws_P.VS_Gain;
    break;

   case 2:
    rtb_Divide_e = AutopilotLaws_P.kntoms_Gain_e * AutopilotLaws_U.in.data.V_tas_kn;
    if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_e) {
      rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_e;
    } else {
      if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_mn) {
        rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_mn;
      }
    }

    rtb_Divide_e = ((AutopilotLaws_P.Constant_Value_b * rtb_Switch2_0 + rtb_Switch2_tmp) * AutopilotLaws_P.Gain_Gain_e -
                    AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain_f / rtb_Divide_e;
    if (rtb_Divide_e > 1.0) {
      rtb_Divide_e = 1.0;
    } else {
      if (rtb_Divide_e < -1.0) {
    ...
    rtb_Sum_ox = AutopilotLaws_P.Gain_Gain_n4 * std::asin(rtb_Divide_e) * AutopilotLaws_P.VS_Gain_a;
    break;

   case 3:
    if (rtb_Switch2_tmp > AutopilotLaws_P.Switch_Threshold_k) {
      rtb_Divide_e = AutopilotLaws_P.kntoms_Gain_i * AutopilotLaws_U.in.data.V_tas_kn;
      if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_b) {
        rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_b;
      } else {
        if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_kq) {
          rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_kq;
        }
      }

      rtb_Divide_e = (AutopilotLaws_P.Constant_Value_k - AutopilotLaws_U.in.data.H_dot_ft_min) *
        AutopilotLaws_P.ftmintoms_Gain_c / rtb_Divide_e;
      if (rtb_Divide_e > 1.0) {
        rtb_Divide_e = 1.0;
      } else {
        if (rtb_Divide_e < -1.0) {
      ...
      rtb_Sum_ox = AutopilotLaws_P.Gain_Gain_j * std::asin(rtb_Divide_e) * AutopilotLaws_P.VS_Gain_j;
   ...
   case 4:
    rtb_Divide_e = AutopilotLaws_P.kntoms_Gain_a * AutopilotLaws_U.in.data.V_tas_kn;
    if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_f) {
      rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_f;
    } else {
      if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_po) {
        rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_po;
      }
    }

    rtb_Divide_e = (AutopilotLaws_U.in.input.H_dot_c_fpm - AutopilotLaws_U.in.data.H_dot_ft_min) *
      AutopilotLaws_P.ftmintoms_Gain_fm / rtb_Divide_e;
    if (rtb_Divide_e > 1.0) {
      rtb_Divide_e = 1.0;
    } else {
      if (rtb_Divide_e < -1.0) {
    ...
    rtb_Sum_ox = AutopilotLaws_P.Gain_Gain_jj * std::asin(rtb_Divide_e) * AutopilotLaws_P.VS_Gain_h;
    break;
   ...
   case 6:
    rtb_Sum_ox = AutopilotLaws_DWork.Delay1_DSTATE_b * look1_binlxpw(AutopilotLaws_U.in.data.H_radio_ft,
   ...
   case 7:
    if (rtb_on_ground > AutopilotLaws_P.Switch_Threshold) {
      ...
      rtb_Divide_e = AutopilotLaws_P.kntoms_Gain_av * AutopilotLaws_U.in.data.V_tas_kn;
      if (AutopilotLaws_P.Constant3_Value_n < rtb_ManualSwitch_i) {
        rtb_ManualSwitch_i = AutopilotLaws_P.Constant3_Value_n;
      }

      if (rtb_Divide_e > AutopilotLaws_P.Saturation_UpperSat_a) {
        rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_a;
      } else {
        if (rtb_Divide_e < AutopilotLaws_P.Saturation_LowerSat_m4) {
          rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_m4;
        }
      }

      rtb_Divide_e = (rtb_ManualSwitch_i - AutopilotLaws_U.in.data.H_dot_ft_min) * AutopilotLaws_P.ftmintoms_Gain_o /
        rtb_Divide_e;
      if (rtb_Divide_e > 1.0) {
        rtb_Divide_e = 1.0;
      } else {
      ...
      rtb_Sum_ox = AutopilotLaws_P.Gain_Gain_jx * std::asin(rtb_Divide_e) * AutopilotLaws_P.VS_Gain_e;
    }
    break;
  ...
  if (rtb_Sum_ox > AutopilotLaws_P.Constant1_Value_i) {
    ...
    rtb_out_c = AutopilotLaws_P.Gain1_Gain_m * AutopilotLaws_P.Constant1_Value_i;
    if (rtb_Sum_ox < rtb_out_c) {
      rtb_Sum_ox = rtb_out_c;
    }
  }

  if (!rtb_Compare_d4) {
    AutopilotLaws_DWork.icLoad_m = 1U;
  }

  if (AutopilotLaws_DWork.icLoad_m != 0) {
    AutopilotLaws_DWork.Delay_DSTATE_o = rtb_GainTheta;
  }

  rtb_Divide_e = rtb_Sum_ox - AutopilotLaws_DWork.Delay_DSTATE_o;
  rtb_ManualSwitch_i = AutopilotLaws_P.Constant2_Value_h1 * AutopilotLaws_U.in.time.dt;
  if (rtb_Divide_e < rtb_ManualSwitch_i) {
    rtb_ManualSwitch_i = rtb_Divide_e;
  }

  rtb_Divide_e = AutopilotLaws_P.Gain1_Gain_h * AutopilotLaws_P.Constant2_Value_h1 * AutopilotLaws_U.in.time.dt;
  if (rtb_ManualSwitch_i > rtb_Divide_e) {
    rtb_Divide_e = rtb_ManualSwitch_i;
  }

  AutopilotLaws_DWork.Delay_DSTATE_o += rtb_Divide_e;
  rtb_Divide_e = AutopilotLaws_U.in.time.dt * AutopilotLaws_P.LagFilter_C1_a;
  rtb_Mod2 = rtb_Divide_e + AutopilotLaws_P.Constant_Value_k3;
  AutopilotLaws_DWork.Delay1_DSTATE_p = 1.0 / rtb_Mod2 * (AutopilotLaws_P.Constant_Value_k3 - rtb_Divide_e) *
    AutopilotLaws_DWork.Delay1_DSTATE_p + (AutopilotLaws_DWork.Delay_DSTATE_o + AutopilotLaws_DWork.Delay_DSTATE_ar) *
    (rtb_Divide_e / rtb_Mod2);
  rtb_Divide_e = static_cast<real_T>(rtb_BusAssignment_output_ap_on) - AutopilotLaws_DWork.Delay_DSTATE_c;
  rtb_ManualSwitch_i = AutopilotLaws_P.RateLimiterVariableTs_up_i * AutopilotLaws_U.in.time.dt;
  if (rtb_Divide_e < rtb_ManualSwitch_i) {
    rtb_ManualSwitch_i = rtb_Divide_e;
  }

  rtb_Divide_e = AutopilotLaws_U.in.time.dt * AutopilotLaws_P.RateLimiterVariableTs_lo_o;
  if (rtb_ManualSwitch_i > rtb_Divide_e) {
    rtb_Divide_e = rtb_ManualSwitch_i;
  }

  AutopilotLaws_DWork.Delay_DSTATE_c += rtb_Divide_e;
  if (AutopilotLaws_DWork.Delay_DSTATE_c > AutopilotLaws_P.Saturation_UpperSat_c) {
    rtb_Divide_e = AutopilotLaws_P.Saturation_UpperSat_c;
  } else if (AutopilotLaws_DWork.Delay_DSTATE_c < AutopilotLaws_P.Saturation_LowerSat_j) {
    rtb_Divide_e = AutopilotLaws_P.Saturation_LowerSat_j;
  } else {
    rtb_Divide_e = AutopilotLaws_DWork.Delay_DSTATE_c;
  }

  rtb_out_c = AutopilotLaws_DWork.Delay1_DSTATE_p * rtb_Divide_e;
  rtb_Divide_e = AutopilotLaws_P.Constant_Value_my - rtb_Divide_e;
  rtb_Divide_e *= rtb_GainTheta;
  AutopilotLaws_Y.out.output.autopilot.Theta_c_deg = rtb_out_c + rtb_Divide_e;
  ...
  AutopilotLaws_DWork.Delay_DSTATE_p = rtb_Mod1_n;
  AutopilotLaws_DWork.Delay_DSTATE_g = rtb_Mod1_i;
  AutopilotLaws_DWork.icLoad = 0U;
  AutopilotLaws_DWork.Delay_DSTATE_m = AutopilotLaws_DWork.Delay_DSTATE_hc;
  AutopilotLaws_DWork.Delay_DSTATE_a = rtb_ManualSwitch;
  AutopilotLaws_DWork.Delay_DSTATE_b = rtb_ROLLLIM1;
  AutopilotLaws_DWork.Delay_DSTATE_l = rtb_out_l;
  AutopilotLaws_DWork.Delay_DSTATE_by = rtb_out;
  AutopilotLaws_DWork.Delay_DSTATE_j = rtb_out_cj;
  AutopilotLaws_DWork.Delay_DSTATE_e = rtb_Minup;
  AutopilotLaws_DWork.icLoad_m = 0U;
  AutopilotLaws_DWork.Delay_DSTATE_ar = AutopilotLaws_DWork.Delay_DSTATE_o;
}
...
void AutopilotLawsModelClass::initialize()
{
...

  {
    ...
    AutopilotLaws_DWork.Delay_DSTATE_p = AutopilotLaws_P.DiscreteDerivativeVariableTs_InitialCondition;
    AutopilotLaws_DWork.Delay_DSTATE_g = AutopilotLaws_P.Delay_InitialCondition_h;
    AutopilotLaws_DWork.Delay1_DSTATE_c = AutopilotLaws_P.Delay1_InitialCondition_a;
    AutopilotLaws_DWork.icLoad = 1U;
    AutopilotLaws_DWork.Delay_DSTATE_m = AutopilotLaws_P.Delay_InitialCondition_g;
    AutopilotLaws_DWork.Delay1_DSTATE_l = AutopilotLaws_P.Delay1_InitialCondition_l;
    AutopilotLaws_DWork.Delay_DSTATE_my = AutopilotLaws_P.RateLimiterVariableTs_InitialCondition;
    AutopilotLaws_DWork.Delay_DSTATE_a = AutopilotLaws_P.DiscreteDerivativeVariableTs_InitialCondition_e;
    AutopilotLaws_DWork.Delay_DSTATE_b = AutopilotLaws_P.Delay_InitialCondition_c;
    AutopilotLaws_DWork.Delay1_DSTATE_j = AutopilotLaws_P.Delay1_InitialCondition_o;
    AutopilotLaws_DWork.Delay_DSTATE_l = AutopilotLaws_P.DiscreteDerivativeVariableTs_InitialCondition_h;
    AutopilotLaws_DWork.Delay_DSTATE_by = AutopilotLaws_P.Delay_InitialCondition_ch;
    AutopilotLaws_DWork.Delay1_DSTATE_b = AutopilotLaws_P.Delay1_InitialCondition_h;
    AutopilotLaws_DWork.Delay_DSTATE_j = AutopilotLaws_P.DiscreteDerivativeVariableTs_InitialCondition_b;
    AutopilotLaws_DWork.Delay_DSTATE_e = AutopilotLaws_P.Delay_InitialCondition_gs;
    AutopilotLaws_DWork.Delay1_DSTATE_cx = AutopilotLaws_P.Delay1_InitialCondition_i;
    AutopilotLaws_DWork.icLoad_m = 1U;
    AutopilotLaws_DWork.Delay_DSTATE_ar = AutopilotLaws_P.Delay_InitialCondition_n;
    AutopilotLaws_DWork.Delay1_DSTATE_p = AutopilotLaws_P.Delay1_InitialCondition_e;
    AutopilotLaws_DWork.Delay_DSTATE_c = AutopilotLaws_P.RateLimiterVariableTs_InitialCondition_p;
    ...
    AutopilotLaws_Chart_Init(&AutopilotLaws_DWork.sf_Chart_df);
    AutopilotLaws_Chart_Init(&AutopilotLaws_DWork.sf_Chart_k);
    AutopilotLaws_Chart_e_Init(&AutopilotLaws_DWork.sf_Chart_e);
    AutopilotLaws_Chart_e_Init(&AutopilotLaws_DWork.sf_Chart_b);
