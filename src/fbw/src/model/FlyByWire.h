...
struct Parameters_FlyByWire_T_ {
  ...
  real_T uDLookupTable_tableData[25];
  ...
  real_T Gain6_Gain_j;
  real_T Gain_Gain_cd;
  real_T Delay_InitialCondition_pd;
  ...
  real_T Saturation_UpperSat_ev;
  real_T Saturation_LowerSat_c3;
  real_T Constant_Value_ia;
  real_T Delay_InitialCondition_k0;
  real_T Constant_Value_o;
  real_T Delay1_InitialCondition_e;
  real_T Delay_InitialCondition_eq;
